...
public final class EventsServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.hotel.EventsService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.example.hotel.EventRequest,
      com.example.hotel.EventResponse> METHOD_HELLO =
      io.grpc.MethodDescriptor.<com.example.hotel.EventRequest, com.example.hotel.EventResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.hotel.EventsService", "hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.hotel.EventRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.example.hotel.EventResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class EventsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.example.hotel.EventRequest request,
        io.grpc.stub.StreamObserver<com.example.hotel.EventResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.hotel.EventRequest,
                com.example.hotel.EventResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class EventsServiceBlockingStub extends io.grpc.stub.AbstractStub<EventsServiceBlockingStub> {
    ...
    /**
     */
    public com.example.hotel.EventResponse hello(com.example.hotel.EventRequest request) {
  ...
  public static final class EventsServiceFutureStub extends io.grpc.stub.AbstractStub<EventsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.hotel.EventResponse> hello(
        com.example.hotel.EventRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.example.hotel.EventRequest) request,
              (io.grpc.stub.StreamObserver<com.example.hotel.EventResponse>) responseObserver);
          break;
        default:
  ...
  private static final class EventsServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.hotel.EventsServiceOuterClass.getDescriptor();
    }
  }
